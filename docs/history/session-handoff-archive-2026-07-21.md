# Session handoff archive — through 2026-07-21

Superseded handoff sections, moved out of `session-handoff.md` to keep the live file readable.
The current state lives in `session-handoff.md`; earlier material still in
`docs/history/session-handoff-archive-2026-07.md`.
