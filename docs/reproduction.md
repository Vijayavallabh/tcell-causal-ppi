# tcell-causal-ppi: full setup, method, and reproduction reference

> This is the exhaustive guide (full method, data inventory, per-module verification, and every
