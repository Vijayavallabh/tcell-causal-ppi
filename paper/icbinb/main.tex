...
established for normalisation either. We did not re-run it; we are recording that the earlier refutation
does not hold, which is the same lesson as \S\ref{sec:causes}, arriving one level further down.
