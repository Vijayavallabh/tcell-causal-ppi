...
C. Architecture is wrong & At $n{=}7$: untyped graph \emph{beats} no-graph ($+0.0043$, survives both) while edge typing is \emph{actively harmful} ($-0.0120$, $7/7$ seeds, survives both); the gate repairs only part of that and not reliably ($+0.0077$, fails correction) & \textbf{Survives} \\
