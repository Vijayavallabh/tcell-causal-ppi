...
$2{,}396{,}160$ message parameters to $599{,}040$ and total parameters by $47\%$, and changing nothing
...
Neither route is it. Cutting the message parameters by a factor of four moves the primary endpoint by
$+0.0004$; if the deficit were capacity or overfitting, that is the intervention that would have fixed
