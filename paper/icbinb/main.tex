...
\textbf{Scope.} Gains reported elsewhere \citep{wenkel2026txpert,cole2026foundation} use different splits and metrics, so our bound constrains this task under this protocol rather than adjudicating those claims. Re-scored under their endpoints our null holds, but the untyped contrast \emph{reverses sign} between TxPert's and \textsc{gears}' headline metrics (Appendix~\ref{app:metrics}).
